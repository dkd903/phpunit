...
FROM alpine:3.11
LABEL mantainer="Petro Shpyhotskyi <shpyhotskyi@gmail.com>"
...
RUN apk --no-cache add \
    ...
    && sed -i 's/nn and/nn, Petro Shpyhotskyi (Docker) and/g' /tmp/vendor/phpunit/phpunit/src/Runner/Version.php \
    # Enable X-Debug
